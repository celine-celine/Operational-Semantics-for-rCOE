...
\\
\stackrel{1}{\longrightarrow} &\langle\ \langle \ e_{id},\ failure,\ lEnv,\ terminated \ \rangle,\ gEnv,\ auxEnv\ \rangle
\\
\stackrel{2}{\longrightarrow} &\langle\ \langle \ e_{id},\ lEnv[env][e][value],\ 
\\
...
\\
\stackrel{1}{\longrightarrow} &\langle\ \langle \ e_{id},\ loc.val(a),\ lEnv,\ running \ \rangle,\ gEnv,\ auxEnv\ \rangle
\\
\stackrel{2}{\longrightarrow} &\langle\ \langle \ e_{id},\ loc.location(a),\ lEnv,\ running \ \rangle,\ gEnv,\ auxEnv\ \rangle
&
\end{flalign*}
\end{small}
...
\\
\stackrel{1}{\longrightarrow} &\langle\ \langle \ e_{id},\ failure,\ st_{func},\ st_{obj},\ env,\ terminated \ \rangle,\ gEnv,\ auxEnv \ \rangle
\\
\stackrel{2}{\longrightarrow} &\langle\ \langle \ e_{id},\ \epsilon,\ lEnv[env]\ \oplus\ \{ \ le[value] \rightarrow loc\},\ running \ \rangle,\ gEnv,\ auxEnv\ \rangle 
\\
& if \ subtype(typeof(le),\ typeof(loc))\ ==\ true 
\\
(assn-3)\ & \langle\ \langle \ e_{id},\ o.a=e;,\ lEnv,\ running\ \rangle,\ gEnv,\ auxEnv\ \rangle
\\
\stackrel{1}{\longrightarrow} &\langle\ \langle \ e_{id},\ \epsilon,\ lEnv,\ running \ \rangle,
\\
&gEnv\ \oplus \{Objects[o][type][a][value] \rightarrow val(e)\},\ auxEnv \ \rangle 
\\
\stackrel{2}{\longrightarrow} &\langle\ \langle \ e_{id},\ \epsilon ,\ lEnv,\ running \ \rangle,
\\
...
(guar-1)\ & fire(guard)
\\
&\overline{\langle\ \langle \ e_{id},\ @\langle guard \rangle,\ \langle pgm \rangle,\ \langle params,vals \rangle,\ \langle \emptyset,\ \emptyset,\ \emptyset \rangle,\ pending\ \rangle,\ gEnv,\ auxEnv\ \rangle}
\\
